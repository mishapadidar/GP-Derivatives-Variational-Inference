...
class GPModel(gpytorch.models.ApproximateGP):
    def __init__(self,num_inducing,num_directions,dim):
        ...
        # XZ: Means for each model instance, we use a different random initialization for inducing points?
        ...
        inducing_directions = inducing_directions.repeat(num_inducing,1) # collect all inducing directions for all inducing points
        num_directional_derivs = num_directions*num_inducing # number of all inducing directions
        ...
        variational_distribution = gpytorch.variational.NaturalVariationalDistribution(num_inducing + num_directional_derivs)
...
if __name__ == "__main__":
  ...
  # # plt.show()
  # plt.savefig(f"./Pred_y_{method}_ntrain{n}_m{num_inducing}_p{num_directions}_e{num_epochs}.pdf")
  ...
  # # plt.show()
  # plt.savefig(f"./Pred_dy1_{method}_ntrain{n}_m{num_inducing}_p{num_directions}_e{num_epochs}.pdf")
  ...
  # # plt.show()
  # plt.savefig(f"./Pred_dy2_{method}_ntrain{n}_m{num_inducing}_p{num_directions}_e{num_epochs}.pdf")
