...
% y_pred = readtable('bunny_DSVGP_ntrain3482_m300_p3_epochs100_standard_standard_expTEST_ntest31335_pred_y.csv');
% V = reshape(y_pred, [nxx, nyy, nzz]);

V = load('bunny_DSVGP_ntrain3482_m300_p3_epochs100_standard_standard_expTEST_ntest31335_V.mat').V;
