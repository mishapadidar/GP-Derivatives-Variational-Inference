...
from gpytorch.lazy import DiagLazyTensor, MatmulLazyTensor, SumLazyTensor, lazify
...
from gpytorch.variational.natural_variational_distribution import NaturalVariationalDistribution
...
class CiqDirectionalGradVariationalStrategy(_VariationalStrategy):
    r"""
